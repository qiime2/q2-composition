...
from q2_composition import ancom, ancom_w
...
class AncomWTests(TestPluginBase):
    ...
    def test_wscores_rnd2(self):
        t = pd.DataFrame([[0, 0, 10.23, 10.42, 10.2, 10.37],
                         [0, 0, 10.1, 10.33, 10.33, 10.29],
                         [10.3, 10.2, 0, 0, 10.24, 10.16],
                         [10.1, 10.17, 0, 0, 10.45, 10.1],
                         [10.05, 10.25, 10.23, 10.36, 0, 0],
                         [10.2, 10.3, 10.17, 10.15, 0, 0]],
